...
from calendar_app_package.calendar_api import GoogleCalendarAPI
...
class TestGoogleCalendarAPI(unittest.TestCase):
    ...
    def test_authenticate_with_existing_token(self, mock_open_file, mock_path_exists, mock_pickle_load, mock_build):
